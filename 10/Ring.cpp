...
void Ring<T>::findByValue()
{
    ...
    cout << "Ââåäèòå ïàðàìåòðû ïîèñêà." << endl;
    system("pause");
    object.changeInf();
    ...
    {
        cout << "Ýëåìåíòîâ ñ çàäàííûì ïàðàìåòðîì â ñïèñêå íå íàéäåíî!" << endl;
    }
...
void Ring<T>::editElement()
{
    ...
    do
    {
        cout << "Ââåäèòå íîìåð ýëåìåíòà, ó êîòîðîãî õîòèòå èçìåíèòü äàííûå: ";
        cin >> choice;
